  ...
  return (
    <section>
      <div className="grid">
        ...
        <div className="col-start-1 row-start-1 flex flex-col py-6 pl-5 gap-6">
          ...
          <div className="justify-start inline-flex items-center">
            <button className="flex bg-white rounded-xs border border-[#063B27] text-[#063B27] text-xs font-bold font-['DM_Sans'] leading-3 items-center gap-1 py-2 px-3">
              Join the waitlist
      ...
      <div className="py-8 pl-4.5 pr-8">
